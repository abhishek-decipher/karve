...
/**
 * <p>Java class for RetrieveClientsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RetrieveClientsResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ResponseData" type="{http://rentacarwebpage.karve.com/}client" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RetrieveClientsResponse", namespace = "http://response.rentacarwebpage.karve.com/", propOrder = {
    "responseVersion",
    "responseCode",
    "responseMessage",
    "responseRunTime",
...
public class RetrieveClientsResponse {
    ...
    protected List<Client> responseData;
     ...
     * 
     */
    public List<Client> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<Client>();
        }
        return this.responseData;
    }

    public void setResponseData(List<Client> responseData) {
