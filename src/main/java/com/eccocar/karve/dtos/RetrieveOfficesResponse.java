...
/**
 * <p>Java class for RetrieveOfficesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RetrieveOfficesResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ResponseData" type="{http://rentacarwebpage.karve.com/}office" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RetrieveOfficesResponse", namespace = "http://response.rentacarwebpage.karve.com/", propOrder = {
    "responseVersion",
    "responseCode",
    "responseMessage",
    "responseRunTime",
...
public class RetrieveOfficesResponse {
    ...
    protected List<Office> responseData;
     ...
     * 
     */
    public List<Office> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<Office>();
        }
        return this.responseData;
    }

    public void setResponseData(List<Office> responseData) {
