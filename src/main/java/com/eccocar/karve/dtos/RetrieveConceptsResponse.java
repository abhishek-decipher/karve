...
/**
 * <p>Java class for RetrieveConceptsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RetrieveConceptsResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ResponseData" type="{http://rentacarwebpage.karve.com/}concept" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RetrieveConceptsResponse", namespace = "http://response.rentacarwebpage.karve.com/", propOrder = {
    "responseVersion",
    "responseCode",
    "responseMessage",
    "responseRunTime",
...
public class RetrieveConceptsResponse {
    ...
    protected List<Concept> responseData;
     ...
     * 
     */
    public List<Concept> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<Concept>();
        }
        return this.responseData;
    }


    public void setResponseData(List<Concept> responseData) {
