...
/**
 * <p>Java class for RetrieveCountriesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RetrieveCountriesResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ResponseData" type="{http://rentacarwebpage.karve.com/}country" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RetrieveCountriesResponse", namespace = "http://response.rentacarwebpage.karve.com/", propOrder = {
    "responseVersion",
    "responseCode",
    "responseMessage",
    "responseRunTime",
...
public class RetrieveCountriesResponse {
    ...
    protected List<Country> responseData;
     ...
     * 
     */
    public List<Country> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<Country>();
        }
        return this.responseData;
    }

    public void setResponseData(List<Country> responseData) {
