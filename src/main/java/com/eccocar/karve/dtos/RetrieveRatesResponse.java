...
/**
 * <p>Java class for RetrieveRatesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RetrieveRatesResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ResponseData" type="{http://rentacarwebpage.karve.com/}rate" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RetrieveRatesResponse", namespace = "http://response.rentacarwebpage.karve.com/", propOrder = {
    "responseVersion",
    "responseCode",
    "responseMessage",
    "responseRunTime",
...
public class RetrieveRatesResponse {
    ...
    protected List<Rate> responseData;
     ...
     * 
     */
    public List<Rate> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<Rate>();
        }
